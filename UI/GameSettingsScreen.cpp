...
void GameSettingsScreen::CreateViews() {
	...
	PopupSliderChoice *savestateCount = systemSettings->Add(new PopupSliderChoice(&g_Config.iSavestateCount, SAVESTATE_MIN, SAVESTATE_MAX, "Savestate count", screenManager()));
